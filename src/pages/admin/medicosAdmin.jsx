// src/pages/admin/MedicosAdmin.jsx
// ─── REESCRITURA COMPLETA — formulario ampliado + tabla mejorada ──────────────
...
// ── Formulario vacío con todos los campos del schema ─────────────────────────
const FORM_INICIAL = {
  nombre:              '',
  primer_apellido:     '',
  email:               '',
  ...
  async function handleGuardar(e) {
    ...
    try {
      if (modal === 'crear') {
        ...
        // Cerrar automáticamente tras 2.5 s
