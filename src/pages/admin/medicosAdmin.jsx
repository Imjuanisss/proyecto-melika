                            ...
                            {loading ? (
                                Array(5).fill(0).map((_, i) => (
                                    <tr key={i} className="skeleton-fila">
                                        {Array(7).fill(0).map((_, j) => (
                                            <td key={j}>
                                                <div className="skeleton-celda" style={{ width: j === 0 ? '140px' : '80px' }} />
                                            </td>
                                        ))}
                                    </tr>
                                ))
                                ...
                                medicos.map(m => (
                                    <tr key={m.id}>
                                        ...
                                        <td>
                                            <span className={m.activo ? 'badge-activo' : 'badge-inactivo'}>
            ...
            {modal && (
                <div className="modal-overlay" onClick={cerrarModal}>
                    <div className="modal-form" onClick={e => e.stopPropagation()}>
                        ...
                        {errorForm && (
                            <div className="medicos-error" style={{ marginBottom: 'var(--space-4)' }}>
                                {errorForm}
                            </div>
                        )}
